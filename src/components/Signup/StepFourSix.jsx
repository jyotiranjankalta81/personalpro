    ...
    <div>
      ...
      <div className='my-5 mx-5 px-5' style={{ width: '35%' }}>
        <Typography variant='body1' id='discrete-slider-small-steps' gutterBottom>
          ...
          <strong>We used AI to generate some fun and <br />creative descriptions for your text block.</strong>
        </Typography>
        <p className='justify-content-center' style={{fontSize:"13px"}}>
          ...
          Customize the text after onboarding to make it sound like<br />you!.
        </p>
        <br />
        <form
