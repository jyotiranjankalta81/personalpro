    ...
    <div>
      ...
      <div className='my-5 mx-5 px-5' style={{ width: '35%' }}>
        <Typography variant='body1' id='discrete-slider-small-steps' gutterBottom>
          ...
          <strong>Do you want to feature links to other<br />people's Beacons,instagram,Tiktok,or Twitter profiles?</strong>
        </Typography>
        <p className='justify-content-center' style={{fontSize:"13px"}}>
          ...
          Direct your visitors to friends,brands you work with,products you belive in, and more.
